...
const testRatingWeight = () => {
    ...
    const result = calculateRestaurantWeight(res, params);
    assert.strictEqual(result.ratingWeight, res.customer_rating * 0.2, "When restaurant rating is higher than searched rating, its 20% of the rating value.");
}
...
const testRatingWeightWithFilter = () => {
    ...
    const result = calculateRestaurantWeight(res, params);
    assert.strictEqual(result.ratingWeight, 0, "When restaurant rating is lower than searched rating, weight should be zero.");
}
